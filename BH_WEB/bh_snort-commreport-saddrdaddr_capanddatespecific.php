<?php
/*COMMENTS
FileName= bh_snort-commreport-saddrdaddrd_capanddatespecific.php 
...
$query ="select count(*) as count, saddr, daddr, class_type, alert_type from bh_table where (capid LIKE '$capid') AND ((sdate >= '$beg_date') AND (sdate <= '$end_date')) AND ((stime >= '$beg_time') AND (stime <= '$end_time')) AND (log_type = 'SNORTLOG') GROUP BY saddr, daddr, class_type, alert_type ORDER BY count DESC";
...
<title>Bloodhound - Snort Communication Report</title>
</head>
<body>
...
if ($beg_date != NULL ){
echo "<h3><u>Snort Communication Report Query - Results </u></h3>";
echo "<b>Query Description:</b> Use this query to see the Communication Report - Count, saddr, daddr, class_type, alert_Type for a specific CapID, Date, and Time.<br /><br />";
echo "
...
echo "<h2>Snort Communication Report</h2>";
echo "<b>Query Description:</b> Use this query to see the Communication Report - Count, saddr, daddr, class_type, alert_Type for a specific CapID, Date, and Time.<br /><br />";
echo ('
