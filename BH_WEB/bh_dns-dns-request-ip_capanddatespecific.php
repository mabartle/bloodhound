...
$query ="select count(*) as count, dns_request from bh_table where (capid LIKE '$capid') AND ((sdate >= '$beg_date') AND (sdate <= '$end_date')) AND ((stime >= '$beg_time') AND (stime <= '$end_time')) AND (log_type = 'DNSLOG') AND ((saddr = '$ip') OR (daddr = '$ip')) GROUP BY dns_request ORDER BY count DESC";
