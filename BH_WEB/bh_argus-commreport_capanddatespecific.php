...
$query ="select count(*) as count, saddr, daddr, proto, sport, dport from argus where (capid LIKE '$capid') AND ((sdate >= '$beg_date') AND (stime >= '$beg_time')) AND ((sdate <= '$end_date') AND (stime <= '$end_time')) GROUP BY saddr, daddr, proto, sport, dport ORDER BY count DESC";
...
<title>Bloodhound - SrcIP Report</title>
</head>
<body>
...
if ($beg_date != NULL ){
echo "<h3><u>Source Query - Results </u></h3>";
echo "<b>Query Description:</b> This query will show a count of all Source IPs used during this capture..<br /><br />";
echo "
...
echo "<h2>Source IP Report</h2>";
echo "<b>Query Description:</b> This query will show a summary of all Source IPs during the time specified.<br /><br />";
echo ('
